...
export const ADMIN_SECTIONS: AdminSection[] = [
  {
    ...
    fields: [
      ...
      { key: "resources", label: "Technical documents", type: "json", help: "JSON list of {label, url}." },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "image", label: "Service image URL", type: "text", help: "Use an approved image from the Media library or an existing site asset." },
      { key: "sort_order", label: "Display order", type: "number" },
      status,
    ],
  },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "slug", label: "URL slug", type: "text", required: true },
      { key: "category", label: "Category", type: "select", options: ["CSR", "Events", "Exhibitions", "Training", "Commercial"] },
      { key: "date", label: "Date", type: "text" },
      { key: "detail", label: "Approved caption", type: "textarea" },
      { key: "image", label: "Cover image URL", type: "text" },
      { key: "gallery", label: "Gallery", type: "json", help: "JSON list of {src, alt}." },
      { key: "video_url", label: "Video URL", type: "text" },
      { key: "video_poster", label: "Video poster URL", type: "text" },
      { key: "external_video_url", label: "External video embed URL", type: "text" },
      { key: "source_url", label: "Original source URL", type: "text" },
      { key: "sort_order", label: "Display order", type: "number" },
      status,
    ],
  },
