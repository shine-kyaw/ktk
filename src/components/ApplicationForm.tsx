  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4">
      ...
      <textarea
        ...
        className={field}
      />
      <label className="mono cursor-pointer border border-dashed border-seam px-4 py-4 text-center text-[0.68rem] uppercase tracking-[0.14em] text-ash transition-colors hover:border-amber hover:text-amber">
      ...
      {sent && (
        <p className="mono text-[0.66rem] uppercase leading-relaxed tracking-[0.14em] text-amber">
