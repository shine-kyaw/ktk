    ...
    return (
      <div className="grain absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute inset-0"
          style={{
            background: "radial-gradient(120% 90% at 85% 110%, rgb(34 90 130 / 0.16) 0%, transparent 55%)",
          }}
        />
      </div>
    );
  ...
  return (
    <div className="grain absolute inset-0 overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(120% 90% at 85% 110%, rgb(34 90 130 / 0.16) 0%, transparent 55%), radial-gradient(90% 70% at 0% 0%, rgb(237 233 224 / 0.05) 0%, transparent 50%)",
        }}
      />
